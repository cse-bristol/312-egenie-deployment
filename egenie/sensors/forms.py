...
class SensorDeploymentDetailsCreateForm(forms.ModelForm):
...
class SensorDeploymentDetailsDisableForm(forms.ModelForm):
...
class SensorDeploymentLocationUpdateForm(forms.ModelForm):
